...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      3.2 Create a method named "calculateBMI" in "MyUtil" class.
          This maethod receives two parmeters of type "double"
      ...
      */
       System.out.println("\n======================Work03=========================");
       System.out.println("BMI: weight: 70 kg, height: 1.75 m (175 cm)");
       System.out.println("BMI = " + calculateBMI(70,1.75));
       System.out.println("Average: v1 = 30, v2 = 30, v3 = 30");
       System.out.println("average = " + average(30,30,30));
       System.out.println("=====================================================");
   }
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       ...
       System.out.println("create person1 id 1");
       Person person1 = new Person(1);
       System.out.println("get id of person1 : " + person1.getId());
       System.out.println("create person2 id 3");
       Person person2 = new Person(3);
       System.out.println("set id of person2 to 2");
       person2.setId(2);
       System.out.println("new id of person2 is : " + person2.getId());
       System.out.println("toString of person1 : " + person1);
       System.out.println("-----------------------------------------------------\n");

       System.out.println("----------------Test BankAccount class---------------");
       System.out.println("create bankAccount1 owner is person1. the number of bankAccount1 is 3");
       BankAccount bankAccount1 = new BankAccount(3,person1);
       System.out.println("create bankAccount2 owner is person2. the number of bankAccount2 is 4");
       BankAccount bankAccount2 = new BankAccount(4,person2);
       System.out.println("get owner of bankAccount1 : " + bankAccount1.getOwner());
       System.out.println("get balance of bankAccount2 : " + bankAccount2.getBalance());
       System.out.println("deposit 2000 into bankAccount1 and 3000 into bankAccount2");
       System.out.println("bankAccount1 balance : " + bankAccount1.deposit(2000));
       System.out.println("bankAccount1 balance : " + bankAccount2.deposit(3000));
       System.out.println("withdraw 1000 from bankAccount1");
       System.out.println("bankAccount1 balance : " + bankAccount1.withdraw(1000));
       System.out.println("transfer 2000 from bankAccount2 to bankAccount1");
       bankAccount2.transfer(2000,bankAccount1);
       ...
       System.out.println("toString of bankAccount2 : " + bankAccount2);
       System.out.println("-----------------------------------------------------");
       System.out.println("=====================================================");
   }
}
